...
transfo = Transformer(vocab_board = vocab_board, vocab_moves=vocab_moves, model_size = model_size,
                      length_board=length_board, max_moves_in_game=max_moves_in_game, num_layers=12, dropout=0.1)
...
# Everything to save
folder_to_save = os.path.join(os.path.dirname(__file__), "Test_nn_17_05_22")
